...
type Advertisement struct {
	...
	User        GetUsersResponseData      `gorm:"references:ID" json:"author,omitempty"`
	Comment     []GetCommentsResponseData `gorm:"references:AdvertisementId" json:"comments,omitempty"`
}
